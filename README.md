...
В игре «Топоры и Тузы» казино загадывает четырёхзначное число без повторяющихся цифр, а вам нужно отгадать его за как можно меньшее число попыток.
...
7 попыток – k = 0.5
<hr>
Создания игры производится на Python3. 
